...
export default function CradVideoTranding({ boxTitle, openBoxPlayed, played, closeBoxPlayed, playVideo, recomended, details }) {
    return (
        <div className="w-full py-3">
            ...
            {
                openBoxPlayed.status.tranding ? <BoxCardPlayed closeBoxPlayed={closeBoxPlayed} playVideo={playVideo} details={details} /> : ''}
        </div>
    )
}
