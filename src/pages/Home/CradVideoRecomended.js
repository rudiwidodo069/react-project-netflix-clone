...
export default function CradVideoRecomended({ boxTitle, openBoxPlayed, played, closeBoxPlayed, playVideo, recomended, details }) {
    return (
        <div className="w-full py-3">
            ...
            {
                openBoxPlayed.status.recomanded ? <BoxCardPlayed closeBoxPlayed={closeBoxPlayed} playVideo={playVideo} details={details} /> : ''}
        </div>
    )
}
